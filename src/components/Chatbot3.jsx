...
const Chatbot1 = ({
  ...
  const handleOpenQuiz = () => {
    ...
    setApiUrl("https://mba.ptit.edu.vn/api_test/random-questions?topic=03_ctdl");
  };
  ...
  const handleSendMessage = async () => {
    if (inputMessage.trim() !== "" && !isLoading) {
      ...
      try {
        const response = await fetch(`https://mba.ptit.edu.vn/rag_api_test/rag/?time=${username}&q=${encodeURIComponent(inputMessage)}&source=khoahocdulieutrongkinhdoanh`, {
          method: "GET",
          headers: new Headers({
